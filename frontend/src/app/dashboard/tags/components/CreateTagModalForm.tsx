...
const CreateTagModalForm: React.FC<{
  onSubmit: (tag: { code: string }) => void;
  onCancel: () => void;
}> = ({ onSubmit, onCancel }) => {
  ...
  return (
    <div className="bg-white p-4">
      <h2 className="text-lg font-semibold mb-4">Create tag category</h2>
...
export default CreateTagModalForm;
